...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CALCREQUEST']._serialized_end=65
  _globals['_CALCRESPONSE']._serialized_start=67
  _globals['_CALCRESPONSE']._serialized_end=112
